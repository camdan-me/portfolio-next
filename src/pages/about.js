          ...
          <div className="flex flex-col sm:ml-8 sm:w-2/3 lg:w-1/2">
            ...
            <h2 className="mt-2 font-bold text-center text-white text-l sm:text-2xl sm:text-left">
              ...
              <div className="flex flex-row justify-center mt-8 sm:justify-start">
                <Link href="/redirect?link=https://youtube.com/@camdan-me" target="_blank">
                ...
                <Link href="/redirect?link=https://github.com/camdan-me" target="_blank">
                ...
                <Link href="/redirect?link=https://api.whatsapp.com/send?phone=13039998067" target="_blank">
                ...
                <Link href="/redirect?link=https://twitter.com/camdan_me" target="_blank">
              ...
              <div className="flex flex-row justify-center mt-8 sm:justify-start">
                <Link href="/redirect?link=https://linkedin.com/in/camdan-me" target="_blank">
                ...
                <Link href="/redirect?link=https://bsky.app/profile/camdan.me" target="_blank">
                ...
                <Link href="/redirect?link=https://discord.com/users/564859369951461406" target="_blank">
                ...
                <Link href="/redirect?link=https://snapchat.com/add/camdan.me" target="_blank">
