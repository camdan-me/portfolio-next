...
export default function Home() {
  return (
    <>
      ...
      <main className="flex items-center justify-center w-screen h-screen overflow-hidden bg-gray-500 bg-cogs">
        <Navbar />
        ...
        <div className="flex flex-col items-center mx-4 sm:flex-row">
          ...
          <h1 className="flex flex-col text-3xl font-black text-center text-white sm:ml-4 sm:text-left sm:text-5xl">
            Coming soon!<br />
            <span className="mt-2 text-xl">In the meantime, you can reach me at <Link href="mailto:hello@camdan.me" target="_blank" className="underline">hello@camdan.me</Link>.<br /><Link href="/?skipanimation" className="underline">Return home</Link>.</span>
          </h1>
        </div>
      </main>
    </>
