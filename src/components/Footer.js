...
export default function Footer() {
	...
	const sha = process.env.VERCEL_GIT_COMMIT_SHA?.substring(0, 7) ?? '0000000';
	const commit = process.env.VERCEL_GIT_COMMIT_MESSAGE ?? '🔃 unstaged changes';
	const author = process.env.VERCEL_GIT_COMMIT_AUTHOR_NAME ?? 'John Doe';
